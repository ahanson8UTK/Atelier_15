...
pkgs <- c("gEcon","tidyverse","quantmod","tsibble","lubridate","zoo","ggplot2")
...
cat("RStudio version:", tryCatch(RStudio.Version()$version, error = \(e) "Not RStudio"), "\n")
...
# Test that gEcon example models are visible (we'll copy rbc.gcn later)
